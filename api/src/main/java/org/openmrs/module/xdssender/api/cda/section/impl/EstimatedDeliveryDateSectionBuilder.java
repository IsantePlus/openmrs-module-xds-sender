...
public class EstimatedDeliveryDateSectionBuilder extends SectionBuilderImpl {
	...
	public Section generate(Entry... entries) {
		...
		retVal.setCode(new CE<String>("57060-6", CdaHandlerConstants.CODE_SYSTEM_LOINC,
		        CdaHandlerConstants.CODE_SYSTEM_NAME_LOINC, null, "Estimated Date of Delivery", null));
		return retVal;
	}
